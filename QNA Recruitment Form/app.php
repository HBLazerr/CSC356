...
<body>
    ...
    <form name="appForm" onsubmit="return validateForm();" action="#" method="post">
        ...
        <div class="row">
            <label>Have you undergone any form of training for covert skills such as stealth, intelligence gathering, or
                weapons expertise?</label>
            <div class="form-inline">
        ...
        <div class="row">
            <label>Are you prepared to take an oath of loyalty and maintain secrecy about the association's
                activities?</label>
            <div class="form-inline">
